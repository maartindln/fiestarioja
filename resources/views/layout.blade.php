...
<html lang="es">
    ...
    <div id="mobile-menu" class="sm:hidden hidden px-4 pt-2 pb-3 space-y-1 transition-all duration-300 ease-in-out">
        <a href="{{ route('index') }}" class="block text-black bg-amber-50 px-3 py-2 rounded-md text-base font-medium">Inicio</a>
        <a href="{{ route('calendar') }}" class="block text-amber-50 px-3 py-2 rounded-md text-base font-medium">Calendario</a>
        <a href="{{ route('list') }}" class="block text-amber-50 px-3 py-2 rounded-md text-base font-medium">Pueblos</a>
    </div>
    </nav>
