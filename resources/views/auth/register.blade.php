        ...
        @if (session('success'))
            <div class="alert flex w-full shadow-2xl rounded-xl overflow-hidden animate__animated animate__fadeInDown border border-green-500/30">
                ...
                <div class="p-4 bg-green-900/95 backdrop-blur-md flex justify-between items-center w-full">
                    <div class="text-green-50 font-medium">{{ session('success') }}</div>
    ...
    <div class="flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-12 w-full z-10">
        ...
        <div class="w-full max-w-md bg-green-900/40 backdrop-blur-sm p-8 sm:p-10 rounded-3xl shadow-2xl border border-green-800/50">
            ...
            <div class="text-center mb-10">
                <img class="mx-auto h-32 sm:h-40 w-auto hover:scale-105 transition-transform duration-500 drop-shadow-lg mb-6" src="{{ asset('images/logos/LOG_TEXT_AMARILLO.png') }}" alt="Logo FiestaRioja">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus
                            class="block w-full pl-11 pr-4 py-3 rounded-xl bg-green-950/50 border border-green-800 text-amber-50 placeholder-green-700 focus:bg-green-950 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/30 transition-all duration-300 outline-none @error('name') border-red-500 focus:border-red-500 focus:ring-red-500/30 @enderror"
                            placeholder="Ej. Juan Pérez">
                    </div>
                    @error('name')
                        <p class="text-red-400 text-xs mt-1.5 ml-1 font-medium"><i class="fa-solid fa-circle-exclamation mr-1"></i>{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email"
                            class="block w-full pl-11 pr-4 py-3 rounded-xl bg-green-950/50 border border-green-800 text-amber-50 placeholder-green-700 focus:bg-green-950 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/30 transition-all duration-300 outline-none @error('email') border-red-500 focus:border-red-500 focus:ring-red-500/30 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" type="password" name="password" required autocomplete="new-password"
                            class="block w-full pl-11 pr-4 py-3 rounded-xl bg-green-950/50 border border-green-800 text-amber-50 placeholder-green-700 focus:bg-green-950 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/30 transition-all duration-300 outline-none @error('password') border-red-500 focus:border-red-500 focus:ring-red-500/30 @enderror"
                            placeholder="••••••••">
                    </div>
                    @error('password')
                        <p class="text-red-400 text-xs mt-1.5 ml-1 font-medium"><i class="fa-solid fa-circle-exclamation mr-1"></i>{{ $message }}</p>
