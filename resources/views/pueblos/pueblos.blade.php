<div x-data="{ open: false }" class="w-full">
    ...
    <div @click="open = true" class="group w-full bg-white px-4 py-4 sm:px-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md hover:border-green-500/50 hover:bg-yellow-200 transition-all duration-300 flex justify-between items-center cursor-pointer mb-2">
