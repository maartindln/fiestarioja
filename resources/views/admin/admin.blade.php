...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        <a href="{{ route('index') }}" class="flex items-center pb-4 border-b border-b-gray-800">
            <img class="h-8 w-auto" src="{{asset('images/logos/TXT_VERDE.png') }}" alt="Logo" />        </a>
        <ul class="mt-4">
                ...
                <li class="dropdown ml-3">
                    <button type="button" class="dropdown-toggle flex items-center">
                        ...
                        <div class="p-2 md:block text-left">
                            <h2 class="text-sm font-semibold text-gray-800">@auth{{ Auth::user()->name }}@endAuth</h2>
                            <p class="text-xs text-gray-500">@auth{{ Auth::user()->role }}@endAuth</p>
                        </div>
                    </button>
               ...
               <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <div class="flex items-center mb-1">
                                <div class="text-3xl font-bold">{{ $pueblosCount }}</div>
                            </div>
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <div class="flex items-center mb-1">
                                <div class="text-3xl font-bold">{{ $visitCount }}</div>
                            </div>
                            ...
                            <tbody>
                                @foreach ($pueblos as $pueblo)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-4 py-2 border">{{ $pueblo->id }}</td>
                                        <td class="px-4 py-2 border">{{ $pueblo->name }}</td>
                                        <td class="px-4 py-2 border">{{ $pueblo->latitude }}</td>
                                        <td class="px-4 py-2 border">{{ $pueblo->longitude }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
