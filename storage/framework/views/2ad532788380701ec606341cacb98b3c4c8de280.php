<div class="w-full px-2 text-green-950 group hover:bg-yellow-500/20 rounded flex justify-between items-center cursor-pointer pb-4 border-b border-gray-300">
    ...
    <h3 class="sm:text-2xl text-xl"><?php echo e($pueblo->date); ?></h3>
...
<?php /**PATH C:\UniServerZ\www\FIESTARIOJA\fiestarioja\resources\views/pueblos/pueblos.blade.php ENDPATH**/ ?>