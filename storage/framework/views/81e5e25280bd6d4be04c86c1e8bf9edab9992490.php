                ...
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="user-<?php echo e($user->id); ?>" class="hover:bg-gray-50">
                                <td class="px-4 py-2 text-center border"><?php echo e($user->id); ?></td>
                                <td class="px-4 py-2 text-center border" id="user-name-<?php echo e($user->id); ?>">
                                    <span><?php echo e($user->name); ?></span>
                                    <input type="text" value="<?php echo e($user->name); ?>" class="hidden border rounded px-2 py-1 w-full" id="edit-name-<?php echo e($user->id); ?>">
                                </td>
                                <td class="px-4 py-2 text-center border" id="user-email-<?php echo e($user->id); ?>">
                                    <span><?php echo e($user->email); ?></span>
                                    <input type="email" value="<?php echo e($user->email); ?>" class="hidden border rounded px-2 py-1 w-full" id="edit-email-<?php echo e($user->id); ?>">
                                </td>
                                <td class="px-4 py-2 text-center border" id="user-role-<?php echo e($user->id); ?>">
                                    <span><?php echo e($user->role); ?></span>
                                    <select name="role" class="hidden border rounded px-2 py-1 w-full" id="edit-role-<?php echo e($user->id); ?>">
                                        <option value="Administrador" <?php echo e($user->role === 'Administrador' ? 'selected' : ''); ?>>Administrador</option>
                                        <option value="Usuario Normal" <?php echo e($user->role === 'Usuario Normal' ? 'selected' : ''); ?>>Usuario Normal</option>
                                    </select>
                                </td>
                                <td class="px-4 py-2 text-center border">
                                    <div class="flex justify-center gap-4" id="icons-<?php echo e($user->id); ?>">
                                        <button onclick="toggleEditFields(<?php echo e($user->id); ?>)" class="text-blue-600 hover:text-blue-800 transition">
                                        ...
                                        <button onclick="confirmDelete(<?php echo e($user->id); ?>)" class="text-red-600 hover:text-red-800 transition">
                                            <i class="fa-solid fa-trash animate__animated fs-5"
                                                onmouseover="this.classList.add('animate__swing');"
                                                onanimationend="this.classList.remove('animate__swing');"></i>
                                        </button>
                                    </div>
                                    <form id="delete-form-<?php echo e($user->id); ?>" action="<?php echo e(route('delete-user', $user->id)); ?>" method="POST" class="hidden">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <button class="hidden mt-2 px-3 py-1 bg-green-600 text-white rounded text-sm hover:bg-green-700"
                                        id="save-<?php echo e($user->id); ?>" onclick="saveChanges(<?php echo e($user->id); ?>)">
                                        Guardar
                                    </button>

                                    <!-- Formulario oculto -->
                                    <form id="update-form-<?php echo e($user->id); ?>" action="<?php echo e(route('users.update', $user->id)); ?>" method="POST" class="hidden">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="name" id="hidden-name-<?php echo e($user->id); ?>" value="<?php echo e($user->name); ?>">
                                        <input type="hidden" name="email" id="hidden-email-<?php echo e($user->id); ?>" value="<?php echo e($user->email); ?>">
                                        <input type="hidden" name="role" id="hidden-role-<?php echo e($user->id); ?>" value="<?php echo e($user->role); ?>">
                                    </form>
                                </td>
                            </tr>
...
<?php echo $__env->make('admin/admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/FIESTARIOJA/fiestarioja/resources/views/admin/allusers.blade.php ENDPATH**/ ?>