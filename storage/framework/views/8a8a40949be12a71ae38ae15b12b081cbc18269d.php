        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                        <a href="<?php echo e(route('allusers')); ?>" class="text-yellow-200 text-sm flex items-center hover:text-yellow-400 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Todos los usuarios</a>
                    </li>
                    <li class="mb-4">
                        <a href="<?php echo e(route('registeruser')); ?>" class="text-yellow-200 text-sm flex items-center hover:text-yellow-400 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Registrar usuarios</a>
                    </li>
                </ul>
            </li>
            <li class="mb-1 group">
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                        <a href="<?php echo e(route('allpueblos')); ?>" class="text-yellow-200 text-sm flex items-center hover:text-yellow-400 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Todos los pueblos</a>
                    </li>
                    <li class="mb-4">
...
<?php /**PATH C:\UniServerZ\www\FIESTARIOJA\fiestarioja\resources\views/admin/admin.blade.php ENDPATH**/ ?>