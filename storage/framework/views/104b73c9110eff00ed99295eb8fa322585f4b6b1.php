                ...
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $pueblos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pueblo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="user-<?php echo e($pueblo->id); ?>" class="hover:bg-gray-50">
                                <td class="px-4 py-2 text-center border"><?php echo e($pueblo->id); ?></td>
                                <td class="px-4 py-2 text-center border" id="user-name-<?php echo e($pueblo->id); ?>">
                                    <span><?php echo e($pueblo->name); ?></span>
                                ...
                                <td class="px-4 py-2 text-center border">
                                    <div class="flex justify-center gap-4" id="icons-<?php echo e($pueblo->id); ?>">
                                        <button onclick="toggleEditFields(<?php echo e($pueblo->id); ?>)" class="text-blue-600 hover:text-blue-800 transition">
                                        ...
                                        <button onclick="confirmDelete(<?php echo e($pueblo->id); ?>)" class="text-red-600 hover:text-red-800 transition">
                                    ...
                                    <button class="hidden mt-2 px-3 py-1 bg-green-600 text-white rounded text-sm hover:bg-green-700"
                                        id="save-<?php echo e($pueblo->id); ?>" onclick="saveChanges(<?php echo e($pueblo->id); ?>)">
                                        Guardar
                                    </button>

                                    <!-- Formulario oculto -->
                                    <form id="update-form-<?php echo e($pueblo->id); ?>" action="<?php echo e(route('users.update', $pueblo->id)); ?>" method="POST" class="hidden">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="name" id="hidden-name-<?php echo e($pueblo->id); ?>" value="<?php echo e($pueblo->name); ?>">
                                        <input type="hidden" name="email" id="hidden-email-<?php echo e($pueblo->id); ?>" value="<?php echo e($pueblo->email); ?>">
                                        <input type="hidden" name="role" id="hidden-role-<?php echo e($pueblo->id); ?>" value="<?php echo e($pueblo->role); ?>">
                                    </form>
                                </td>
                            </tr>
...
<?php echo $__env->make('admin/admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/FIESTARIOJA/fiestarioja/resources/views/admin/allpueblos.blade.php ENDPATH**/ ?>